          ...
          <div style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius: 5px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
            ...
            <div style="color: #555555;">
              ...
              <p style="text-align: center;">
                <a href="https://project-vpp.vercel.app/account/cart" style="display: inline-block; background-color: #4CAF50; color: #FFFFFF; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">Xem hóa đơn</a>
              </p>
            </div>
          </div>
        </div>
